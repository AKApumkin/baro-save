...
PerformanceFix.ShowGUI = function ()
    local frame = GUI.Frame(GUI.RectTransform(Vector2(0.5, 0.6), GUI.Screen.Selected.Frame.RectTransform, GUI.Anchor.Center))
    ...
    local clientMapEntityUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)
    ...
    local serverMapEntityUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)
    ...
    GUI.TextBlock(GUI.RectTransform(Vector2(1, 0.05), config.Content.RectTransform), "Client Gap Update Interval", nil, nil, GUI.Alignment.Center, true)

    local clientGapUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)

    clientGapUpdateInterval.MinValueInt = 1
    clientGapUpdateInterval.MaxValueInt = 60

    clientGapUpdateInterval.IntValue = PerformanceFix.Config.clientGapUpdateInterval
    
    clientGapUpdateInterval.OnValueChanged = function ()
        PerformanceFix.Config.clientGapUpdateInterval = clientGapUpdateInterval.IntValue
    end


    GUI.TextBlock(GUI.RectTransform(Vector2(1, 0.05), config.Content.RectTransform), "Server Gap Update Interval", nil, nil, GUI.Alignment.Center, true)

    local serverGapUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)

    serverGapUpdateInterval.MinValueInt = 1
    serverGapUpdateInterval.MaxValueInt = 60

    serverGapUpdateInterval.IntValue = PerformanceFix.Config.serverGapUpdateInterval

    serverGapUpdateInterval.OnValueChanged = function ()
        PerformanceFix.Config.serverGapUpdateInterval = serverGapUpdateInterval.IntValue
    end
    ...
    local poweredUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)
    ...
    local clientCharacterUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)
    ...
    local serverCharacterUpdateInterval = GUI.NumberInput(GUI.RectTransform(Vector2(1, 0.1), config.Content.RectTransform), GUI.NumberInput.NumberType.Int)
    ...
    singleplayerPermanent.OnSelected = function ()
        PerformanceFix.Config.allowSingleplayerPermanentConfigs = singleplayerPermanent.State == 3
    end
    ...
    shadowCasting.OnSelected = function ()
        PerformanceFix.Config.disableShadowCastingLights = shadowCasting.State == 3
    end
    ...
    drawBehindSub.OnSelected = function ()
        PerformanceFix.Config.disableDrawBehindSubsLights = drawBehindSub.State == 3
    end
    ...
    hideInGameWires.OnSelected = function ()
        PerformanceFix.Config.hideInGameWires = hideInGameWires.State == 3
    end
    ...
    hideInGameComponents.OnSelected = function ()
        PerformanceFix.Config.hideInGameComponents = hideInGameComponents.State == 3
    end
end

PerformanceFix.HideGUI = function()
    if PerformanceFix.GUIFrame then
        ClearElements(PerformanceFix.GUIFrame, true)
    end
end

PerformanceFix.GUIOpen = false
PerformanceFix.ToggleGUI = function ()
    PerformanceFix.GUIOpen = not PerformanceFix.GUIOpen

    if PerformanceFix.GUIOpen then
        PerformanceFix.ShowGUI()
    else
        PerformanceFix.HideGUI()
    end
end